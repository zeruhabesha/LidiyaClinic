...
$retrieved = mysqli_query($db,$sqluser);
   ...
   <input type='text' name='fname' placeholder='Enter drug trade name' value='' class='form-control' required>
       </div>
       <div class='input-group' style='margin-bottom:10px;margin-top: 10px;'>
    <span class='input-group-addon'>Strength</span>
   <input type='text' name='strength' placeholder='Enter drug strength' value='' class='form-control' required>
       </div>
   ...
   <input type='text' id='txt4'  onkeyup='sum();' placeholder='Amount' name='quantity' class='form-control' required/>
    </div>
    <div class='input-group' style='margin-bottom:10px;'>
       <span class='input-group-addon'>Purchased Price</span>   
   <input type='text' id='txt1'  onkeyup='sum();' name='pprice' placeholder='Purchasing Price' class='form-control' required>
 </div>
  ...
  <div class='input-group' style='margin-bottom:10px;'>
          ...
          <input type='text' id='txt2'  onkeyup='sum();' placeholder='e.g 1.5' name='marker' required/>
     </div>
...
<div class='input-group' style='margin-bottom:10px;margin-top: 10px'>
    <span class='input-group-addon'>Vendor Full Name</span>
     <input type='text' name='vendorname' placeholder='Vendor full name' class='form-control' value='' required>
     </div>
     <div class='input-group' style='margin-bottom:10px;'>
     
      <span class='input-group-addon'>Location</span>
   <input type='text' name='vendorlocation' placeholder='Vendor location' class='form-control' value=''  required>
  </div>
  <div class='input-group' style='margin-bottom:10px;'>
    <span class='input-group-addon'>Contact phone</span>
     <input type='phone' name='vendorphone' placeholder='Enter Vendor phone' class='form-control' value=''required >
     </div>
     <div class='input-group' style='margin-bottom:10px;'>
    <span class='input-group-addon'>Vendor Email</span>
   <input type='email' name='vendoremail' placeholder='Amount' value='' class='form-control' required>
    </div>
<div class='input-group' style='margin-bottom:10px; margin-top:15px;'>
    <span class='input-group-addon'>Manufactured date</span>
   <input type='date' placeholder='Purchased date' name='ppdss' class='form-control' value='' required>
   </div>
  <div class='input-group' style='margin-bottom:10px; margin-top:15px;'>
    <span class='input-group-addon'>Expire date</span>
   <input type='date' placeholder='Expire date' name='dob' class='form-control' value='' required>
   </div>	
