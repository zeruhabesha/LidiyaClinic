 	...
 	<!-- requried-jsfiles-for owl -->
        ...
        <thead>
            <tr>
                ...
                <th>History</th>
                <th>Exam</th>
                <th>Diagnose</th><th>Appointment</th>
                <th>Prescribe</th>            
        ...
        <tbody>
        	 ...
        	 $sqlmember ="SELECT * FROM tbl_petients WHERE Status='Consultation' || appointment='yes' ORDER BY id DESC ";
			       $retrieve = mysqli_query($db,$sqlmember);
                     while($found = mysqli_fetch_array($retrieve))
	                 {
                     $ID=$found['ID_Number'];  $title=$found['Mtitle'];$firstname=$found['Firstname'];$sirname=$found['Sirname'];
                       $phone=$found['Phone'];$location=$found['Location']; $Middlename=$found['Middlename'];
                       $id=$found['id']; $dob=$found['DOB'];
			                $count=$count+1;   $gender=$found['Gender']; $appointment=$found['appointment'];
			              $names= $title.' '.$firstname.' '.$Middlename.' '.$sirname;
				        ...
				        echo"<tr>  
                             ...
                             <td>$title $firstname $Middlename $sirname</td>        	
                             <td>$age</td>
                             <td>$gender</td>
							...
							<a data-toggle='modal' data-ds='$dsd' data-c5='$commrdt' data-a5='$mrdt'  data-c7='$comtft' data-a7='$tft' data-bp='$tbp' data-c1='$comfbs' data-gl='$tgl' data-c2='$comrbs' data-ml='$tml' data-c4='$compbs' data-hv='$thv' data-c3='$comuct' data-a6='$fbc' data-c6='$comfbc' data-a8='$lft' data-c8='$comlft' data-id='$id' data-dp='$names' data-pd='$tests' data-dd='$results' href='#displayschoolsteachers2' class='open-patient2 btn $btn' title='Click here to prescribe patient'><span class='fa fa-edit fa-lg' style='color:white;' ></span></a>
							      ...
							      <td>
							<a data-toggle='modal' data-c5='$title' data-a5='$firstname'  data-b1='$Middlename' data-a7='$sirname' data-c1='$appointment' data-s1='$ID' data-id='$id'  href='#displayschoolsteache' class='open-Cod btn  btn-info' title='Click here to Appointment patient'><span class='fa fa-edit fa-lg' style='color:white;' ></span></a>
