 	...
 	<!-- requried-jsfiles-for owl -->
		...
		$date=date('y-m-d');
				        ...
				        echo"<tr>  
			                 ...
			                 <td>
			                   <a data-toggle='modal'  data-id='$id'  data-ig='$ID' data-em='$title' data-ep='$firstname' data-et='$sirname' data-pm='$age' data-dp='$gender' class='certificate12 btn btn-primary' title='print petient' ><span class='fa fa-edit' style='color:white;'></span></a>
