...
$query2 = "select * from tbl_petients order by id desc limit 1";
  ...
  $ID = str_pad($IDD + 1, 4, 0, STR_PAD_LEFT);
				...
				<div class='middle-content'>
					...
					<!-- start content_slider -->
				         <div class='alert alert-info'>
                             <i class='fa fa-info'></i>&nbsp;Use the form below to enter petient details
                         </div>
    ...
    <span class='input-group-addon'>Petient ID</span>
   <input type='text' style='color:red;' name='fname' placeholder='Petient ID' value='$customer_ID' class='form-control' readonly>
       </div> 
   ...
   <input type='text' name='fname' placeholder='Enter First Name' value='' class='form-control' required>
       </div>
       <div class='input-group' style='margin-bottom:10px;'>
       <span class='input-group-addon'>Other Name</span>
   <input type='text' name='mname' placeholder='Other name'  value='' class='form-control'   value=''  required>
 </div>
 <div class='input-group' style='margin-bottom:10px;'>
    <span class='input-group-addon'>Last Name</span>
   <input type='text' name='lname' placeholder='Last name' value='' class='form-control' required>
    </div>
    <div class='input-group' style='margin-bottom:10px;'>
  ...
  <div class='input-group' style='margin-bottom:10px; '>
   ...
   <input type='date' placeholder='Payment Log date' name='dob' class='form-control' value='' required>
   </div>	
   ...
   <input type='text' name='village' placeholder='Residential area' class='form-control' value=''  required>
  </div>	
  <div class='input-group' style='margin-bottom:10px;'>
    <span class='input-group-addon'>Next of Kin</span>
     <input type='text' name='guardian' placeholder='Enter Guardian' class='form-control' value='' required>
     </div>
     <div class='input-group' style='margin-bottom:10px;'>
   ...
   <select  name='relationshipd' style='height:30px; width: 100%' >
		                            ...
		                            <option>Husband</option>									             			 	
				                     <option>Wife</option>   <option>Other</option>             
            				                         </select>
   ...
   <input type='number' name='phone' placeholder='Enter Phone'  value='' class='form-control'   value='' required>
  </div>
  <div class='input-group' style='margin-bottom:10px;'>
      <span class='input-group-addon'>Patient Phone</span>
   <input type='number' name='kphone' placeholder='Enter Phone'  value='' class='form-control'   value='' required>
  </div>
  <div class='input-group' style='margin-bottom:10px;'>
